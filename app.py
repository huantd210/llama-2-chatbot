...
MAX_INPUT_MAX_NEW_TOKENS = int(os.getenv("MAX_INPUT_MAX_NEW_TOKENS"))
...
def generate(
    ...
    if max_new_tokens > MAX_INPUT_MAX_NEW_TOKENS:
        raise ValueError
...
with gr.Blocks(css="style.css") as app:
    ...
    with gr.Accordion(label="Advanced options", open=False):
        ...
        max_new_tokens = gr.Slider(
            ...
            minimum=1,
            maximum=MAX_INPUT_MAX_NEW_TOKENS,
            step=1,
...
app.queue(max_size=20).launch(
    share=False, server_name=SERVER_NAME, server_port=SERVER_PORT
)
